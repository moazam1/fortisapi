...
/**
 * Builder for model Filter10
 *
 * @see Filter10
 */
class Filter10Builder
{
    /**
     * @var Filter10
     */
    ...
    private function __construct(Filter10 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new filter 10 Builder object.
     */
    public static function init(): self
    {
        return new self(new Filter10());
    }
     ...
     */
    public function lastRegistrationTs($value): self
    {
    ...
    /**
     * Initializes a new filter 10 object.
     */
    public function build(): Filter10
    {
