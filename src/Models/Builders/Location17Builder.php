...
use FortisAPILib\Models\Location17;

/**
 * Builder for model Location17
 *
 * @see Location17
 */
class Location17Builder
{
    /**
     * @var Location17
     */
    ...
    private function __construct(Location17 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new location 17 Builder object.
     */
    public static function init(string $id, int $createdTs, int $modifiedTs, string $name, string $parentId): self
    {
        return new self(new Location17($id, $createdTs, $modifiedTs, $name, $parentId));
    }
    ...
    /**
     * Initializes a new location 17 object.
     */
    public function build(): Location17
    {
