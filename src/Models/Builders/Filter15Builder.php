...
/**
 * Builder for model Filter15
 *
 * @see Filter15
 */
class Filter15Builder
{
    /**
     * @var Filter15
     */
    ...
    private function __construct(Filter15 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new filter 15 Builder object.
     */
    public static function init(): self
    {
        return new self(new Filter15());
    }
     ...
     */
    public function lastLoginTs($value): self
    {
     ...
     */
    public function termsAcceptedTs($value): self
    {
    ...
    /**
     * Initializes a new filter 15 object.
     */
    public function build(): Filter15
    {
