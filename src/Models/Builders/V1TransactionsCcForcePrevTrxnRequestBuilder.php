...
class V1TransactionsCcForcePrevTrxnRequestBuilder
{
     ...
     */
    public static function init(string $previousTransactionId, string $authCode): self
    {
        return new self(new V1TransactionsCcForcePrevTrxnRequest($previousTransactionId, $authCode));
    }
