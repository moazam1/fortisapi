...
/**
 * Builder for model Filter2
 *
 * @see Filter2
 */
class Filter2Builder
{
    /**
     * @var Filter2
     */
    ...
    private function __construct(Filter2 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new filter 2 Builder object.
     */
    public static function init(): self
    {
        return new self(new Filter2());
    }
    ...
    /**
     * Initializes a new filter 2 object.
     */
    public function build(): Filter2
    {
