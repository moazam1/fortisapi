...
class V1TokensTerminalRequestBuilder
{
     ...
     */
    public static function init(string $contactId, string $locationId, string $terminalId): self
    {
        return new self(new V1TokensTerminalRequest($contactId, $locationId, $terminalId));
    }
