...
/**
 * Builder for model Filter1
 *
 * @see Filter1
 */
class Filter1Builder
{
    /**
     * @var Filter1
     */
    ...
    private function __construct(Filter1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new filter 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new Filter1());
    }
    ...
    /**
     * Initializes a new filter 1 object.
     */
    public function build(): Filter1
    {
