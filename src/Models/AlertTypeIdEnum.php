...
class AlertTypeIdEnum
{
    ...
    private const _ALL_VALUES = [self::ENUM_0, self::ENUM_1, self::ENUM_2, self::ENUM_3, self::ENUM_4, self::ENUM_5];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for AlertTypeIdEnum.");
    }
}
