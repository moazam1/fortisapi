...
| `accountNumber` | ?(string) | Optional | This is a nested AnyOf case. | getAccountNumber(): ?string | setAccountNumber(?string accountNumber): void |
...
| `expDate` | ?(string) | Optional | This is a nested AnyOf case. | getExpDate(): ?string | setExpDate(?string expDate): void |
