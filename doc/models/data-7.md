...
| `brandingDomain` | `array` | Required | Branding domain array | getBrandingDomain(): array | setBrandingDomain(array brandingDomain): void |
| `productTransactions` | `array[]` | Required | Product Transactions array | getProductTransactions(): array | setProductTransactions(array productTransactions): void |
| `productFile` | `array` | Required | Product file array | getProductFile(): array | setProductFile(array productFile): void |
| `productAccountvault` | `array` | Required | Product Token array | getProductAccountvault(): array | setProductAccountvault(array productAccountvault): void |
| `productRecurring` | `array` | Required | Product recurring array | getProductRecurring(): array | setProductRecurring(array productRecurring): void |
| `tags` | `array[]` | Required | Tags array | getTags(): array | setTags(array tags): void |
| `terminals` | `array[]` | Required | Terminals array | getTerminals(): array | setTerminals(array terminals): void |
