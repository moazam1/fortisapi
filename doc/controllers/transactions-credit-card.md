...
```php
$body = V1TransactionsCcAuthOnlyKeyedRequestBuilder::init(
    1,
    '5454545454545454',
    '0722'
)
...
```php
$body = V1TransactionsCcAuthOnlyPrevTrxnRequestBuilder::init(
...
```php
function cCAuthOnlyTerminal(V1TransactionsCcAuthOnlyTerminalRequest $body): ResponseAsyncProcessing
```
...
```php
$body = V1TransactionsCcAuthOnlyTerminalRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a',
    1,
    '11e95f8ec39de8fbdb0a4f1a'
)
...
```php
$body = V1TransactionsCcAuthOnlyTicketRequestBuilder::init(
    1,
    '11e95f8ec39de8fbdb0a4f1a'
)
    ->checkinDate('2021-12-01')
...
```php
$body = V1TransactionsCcAuthOnlyTokenRequestBuilder::init(
    1
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
...
```php
$body = V1TransactionsCcAvsOnlyKeyedRequestBuilder::init(
    '5454545454545454',
    '0722'
)
    ->checkinDate('2021-12-01')
...
```php
$body = V1TransactionsCcAvsOnlyPrevTrxnRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a'
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
...
```php
function cCAVSTerminal(V1TransactionsCcAvsOnlyTerminalRequest $body): ResponseAsyncProcessing
```
...
```php
$body = V1TransactionsCcAvsOnlyTerminalRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a',
    '11e95f8ec39de8fbdb0a4f1a'
)
    ->checkinDate('2021-12-01')
...
```php
$body = V1TransactionsCcAvsOnlyTicketRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a'
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
...
```php
$body = V1TransactionsCcAvsOnlyTokenRequestBuilder::init()
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
    ->clerkNumber('AE1234')
    ->contactId('11e95f8ec39de8fbdb0a4f1a')
...
```php
$body = V1TransactionsCcForceKeyedRequestBuilder::init(
    '5454545454545454',
    '0722',
    'abc123'
)
...
```php
$body = V1TransactionsCcForcePrevTrxnRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a',
    'auth_code2'
)
    ->checkinDate('2021-12-01')
...
```php
$body = V1TransactionsCcForceTicketRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a',
    'abc123'
)
    ->checkinDate('2021-12-01')
...
```php
$body = V1TransactionsCcForceTokenRequestBuilder::init(
    'abc123'
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
...
```php
$body = V1TransactionsCcRefundKeyedRequestBuilder::init(
    1
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
...
```php
$body = V1TransactionsCcRefundPrevTrxnRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a'
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
...
```php
function cCRefundTerminal(V1TransactionsCcRefundTerminalRequest $body): ResponseAsyncProcessing
```
...
```php
$body = V1TransactionsCcRefundTerminalRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a',
    1,
    '11e95f8ec39de8fbdb0a4f1a'
)
...
```php
$body = V1TransactionsCcRefundTicketRequestBuilder::init(
    1,
    '11e95f8ec39de8fbdb0a4f1a'
)
    ->checkinDate('2021-12-01')
...
```php
$body = V1TransactionsCcRefundTokenRequestBuilder::init(
    1
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
...
```php
$body = V1TransactionsCcSaleKeyedRequestBuilder::init(
    1,
    '5454545454545454',
    '0722'
)
...
```php
$body = V1TransactionsCcSalePrevTrxnRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a'
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
...
```php
function cCSaleTerminal(V1TransactionsCcSaleTerminalRequest $body): ResponseAsyncProcessing
```
...
```php
$body = V1TransactionsCcSaleTerminalRequestBuilder::init(
    '11e95f8ec39de8fbdb0a4f1a',
    1,
    '11e95f8ec39de8fbdb0a4f1a'
)
...
```php
$body = V1TransactionsCcSaleTicketRequestBuilder::init(
    1,
    '11e95f8ec39de8fbdb0a4f1a'
)
    ->checkinDate('2021-12-01')
...
```php
$body = V1TransactionsCcSaleTokenRequestBuilder::init(
    1
)
    ->checkinDate('2021-12-01')
    ->checkoutDate('2021-12-01')
